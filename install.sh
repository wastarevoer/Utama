...
installTheme(){
    ...
    rm -r Utama
    git clone https://github.com/ZassXdOfficial/Utama.git
    cd Utama
...
repair(){
    bash <(curl https://raw.githubusercontent.com/ZassXdOfficial/Utama/main/repair.sh)
}
